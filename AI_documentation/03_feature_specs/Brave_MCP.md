...
### Infrastructure
- **Brave MCP Server**: Docker-based MCP toolkit with API key `BSAHt0pS1n4rjFHn3chw4ISI6t6GC1C`
...
- **API Key**: `BSAHt0pS1n4rjFHn3chw4ISI6t6GC1C` (will be moved to .env)
