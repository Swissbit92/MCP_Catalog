...
- Professional presentation with voice actor credits
...
└── CharacterShowcase (NEW - immersive carousel experience)
    ...
    │   ├── CharacterHeader (name, VA, portrait)
...
- [ ] Intuitive poster-based navigation
- [ ] Professional character presentation
- [ ] Seamless mobile carousel experience
...
4. **Create overlay panels**: Slide-in information displays
5. **Integrate character data**: Connect with existing `/personas` API
6. **Test carousel navigation**: Ensure smooth poster transitions
7. **Apply HSR styling**: Professional dark theme and typography
